...
@section('content')
<h2 class="text-2xl font-bold text-center mb-4 text-[#1f2937] dark:text-white">Gym Owner Login</h2>
...
<div class="mt-4">
    ...
    <a href="{{ route('gymowner.register') }}" class="text-[#6366f1] hover:underline ml-1">Register here</a>
</div>
@endsection 